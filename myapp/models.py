...
class Post(models.Model): #テーブル作成
    author = models.ForeignKey(User, on_delete=models.PROTECT, blank=False) #外部(Userモデル)から値を参照 PROTECT->削除しようとしてるユーザーの投稿があったら削除できないようにする
